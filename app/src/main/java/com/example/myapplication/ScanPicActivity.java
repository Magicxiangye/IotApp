...
import pic.PicAdapter;
import pic.PicEntity;
import tools.Generic;

public class ScanPicActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
